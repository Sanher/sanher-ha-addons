...
- Sync upstream `sanher/17Track_app` (v2.6.19): chore(version): bump to version 2.6.19.

## 2.6.18

- Sync upstream `sanher/17Track_app` (v2.6.18): chore(version): bump to version 2.6.18.

## 2.6.17

- Sync upstream `sanher/17Track_app` (v2.6.17): chore(version): bump to version 2.6.17.
...
- Sync upstream `sanher/17Track_app` (v2.6.13): chore(version): bump to version 2.6.13.

## 2.6.12

- Sync upstream `sanher/17Track_app` (v2.6.12): chore(version): bump to version 2.6.12.
...
- Sync upstream `sanher/17Track_app` (v2.6.9): chore(version): bump to version 2.6.9.

## 2.6.8

- Sync upstream `sanher/17Track_app` (v2.6.8): chore(version): bump to version 2.6.8.

## 2.6.7

- Sync upstream `sanher/17Track_app` (v2.6.7): chore(version): bump to version 2.6.7.

## 2.6.6

- Sync upstream `sanher/17Track_app` (v2.6.6): chore(version): bump to version 2.6.6.
...
- Sync upstream `sanher/17Track_app` (v2.6.2): chore(version): bump to version 2.6.2.
- Sincroniza el worker IMAP empaquetado con la version actual del backend `v2.6.2`.

## 2.6.1

- Sync upstream `sanher/17Track_app` (v2.6.1): chore(version): bump to version 2.6.1.
